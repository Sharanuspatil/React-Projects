...
async function getStaticProps() {
  ...
  const client = await external_mongodb_["MongoClient"].connect("mongodb+srv://Sharanu:Patil@123@cluster0.yp3rc.mongodb.net/myFirstDatabase?retryWrites=true&w=majority");
  const db = client.db();
