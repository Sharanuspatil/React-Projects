                ...
                <div className="col-md-4 col-sm-4">
                  <div className="footer-pad">
                    ...
                    <p>
                      ...
                      delectus error dignissimos ab corrupti quas rerum impedit
                      ad distinctio cum fuga consectetur inventore voluptatibus
                      officiis?
                    </p>
                  </div>
                </div>
              ...
              <div className="row">
                <div className="col-md-12 copy">
                  <p className="text-center">
                    &copy; Copyright 2021 - Swadeshi. All rights reserved.
                  </p>
                </div>
              </div>
            </div>
